neutron-plugin-openvswitch-agent-ini:
  file:
    - managed
    ...
    - mode: 644
    - require:
      - file: neutron-plugin-openvswitch-agent-dir

neutron-plugin-openvswitch-agent-ini-values:
  ini:
    - options_present
    - name: /etc/neutron/plugins/openvswitch/ovs_neutron_plugin.ini
    - sections:
...
neutron-plugin-openvswitch-agent-dir:
  file:
    - directory
    - name: /etc/neutron/plugins/openvswitch
    - group: neutron
    - user: neutron
    - makedirs: "True"
    - require:
...
neutron-plugin-openvswitch-agent:
  ...
  service:
    ...
    - watch:
      - pkg: neutron-plugin-openvswitch-agent
      - ini: neutron-plugin-openvswitch-agent-ini-values
      - ini: neutron-conf
